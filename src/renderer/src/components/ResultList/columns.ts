...
function fmtFormat(t: Track): string {
  if (t.bitDepth && t.sampleRate)
    return `${Math.round(t.sampleRate / 1000)} ${t.bitDepth}`;
  return ext(t);
}
...
export const ALL_COLUMNS: ColumnDef[] = [
  {
    ...
    defaultWidth: 260,
    value: (t) => t.filename,
    sortValue: (t) => t.filename.toLowerCase(),
  },
  {
    key: "duration",
    label: "Duration",
  ...
  },
  {
    ...
    label: "Library",
    defaultWidth: 220,
    value: (t, c) => libraryPath(t, c),
    sortValue: (t, c) => libraryPath(t, c).toLowerCase(),
  },
  {
    key: "publisher",
    label: "Publisher",
  ...
  { key: "project", label: "Project", defaultWidth: 120, value: () => "" },
  {
    ...
    label: "Category",
    defaultWidth: 130,
    value: (t) => (t.category ? toTitleCase(t.category) : ""),
  ...
  },
  {
    ...
    label: "Sub Category",
    defaultWidth: 130,
    value: (t) => (t.subcategory ? toTitleCase(t.subcategory) : ""),
    sortValue: (t) => (t.subcategory ?? "").toLowerCase(),
  },
  ...
  },
  {
    ...
    label: "Date Added",
    defaultWidth: 110,
    value: (t) => fmtDate(t.addedAt),
    sortValue: (t) => t.addedAt ?? 0,
  },
  {
    key: "fileFormat",
    label: "File Format",
  ...
  },
  {
    ...
    defaultWidth: 240,
    value: (t) => t.filePath,
    sortValue: (t) => t.filePath.toLowerCase(),
  },
  {
  ...
  {
    key: "ucsUsercategory",
    label: "UCS Usercategory",
    defaultWidth: 130,
    value: () => "",
  },
  {
    key: "ucsVendorcategory",
    label: "UCS Vendorcategory",
    defaultWidth: 140,
    value: () => "",
  },
  {
