...
const MODE_OPTIONS: Array<{ value: PublisherRule['mode']; label: string; description: string }> = [
  {
...
export default function PublisherSettingsModal({ value, onSave, onCancel }: PublisherSettingsModalProps): JSX.Element {
  ...
  return (
    <div className="modal-overlay" onMouseDown={onCancel}>
      <div className="modal modal--wide publisher-modal" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className="publisher-modal__body">
            ...
            {MODE_OPTIONS.map((option) => (
              ...
              >
                ...
                <span className="publisher-modal__choice-text">
                  <span className="publisher-modal__choice-label">{option.label}</span>
                  <span className="publisher-modal__choice-desc">{option.description}</span>
                </span>
              </label>
            ))}
          </div>
          ...
          <div className="publisher-modal__custom">
            <div className="publisher-modal__custom-row">
              ...
              />
              <button className="modal__btn" onClick={() => void pickFolder()} disabled={!window.api?.selectFolder}>
                Choose folder
              </button>
            </div>
            <div className="publisher-modal__hint">
              Custom mode accepts a folder path or a path pattern. If the path does not match a sound, the app shows '-'.
            </div>
          </div>
        </div>
