...
export const TAXONOMY: CategoryRule[] = [
  {
    category: 'Impact',
    keywords: ['impact', 'hit', 'punch', 'slam', 'boom', 'smash', 'thud', 'bang', 'crash', 'strike', 'thump'],
    subcategories: [
      { name: 'Metal Impact', keywords: ['metal', 'metallic', 'steel', 'iron', 'pipe'] },
      { name: 'Wood Impact', keywords: ['wood', 'wooden', 'plank', 'crate', 'timber'] },
      { name: 'Soft Hit', keywords: ['soft', 'pillow', 'cloth', 'muffled', 'light'] },
      { name: 'Heavy Hit', keywords: ['heavy', 'big', 'large', 'huge', 'massive', 'deep'] }
    ]
  },
  {
    category: 'UI',
    keywords: ['ui', 'button', 'click', 'select', 'confirm', 'cancel', 'menu', 'tap', 'beep', 'notification', 'popup'],
    subcategories: [
      { name: 'Button Click', keywords: ['click', 'tap', 'press', 'button'] },
      { name: 'Hover', keywords: ['hover', 'rollover', 'over'] },
      { name: 'Confirm', keywords: ['confirm', 'accept', 'ok', 'success', 'complete'] },
      { name: 'Error', keywords: ['error', 'fail', 'denied', 'wrong', 'invalid', 'warning'] }
    ]
  },
  {
    category: 'Whoosh',
    keywords: ['whoosh', 'swipe', 'swish', 'transition', 'passby', 'pass by', 'flyby', 'fly by', 'swoosh'],
    subcategories: [
      { name: 'Fast Whoosh', keywords: ['fast', 'quick', 'rapid', 'sharp'] },
      { name: 'Slow Whoosh', keywords: ['slow', 'long', 'smooth'] },
      { name: 'Magical Whoosh', keywords: ['magic', 'magical', 'sparkle', 'fairy', 'shimmer'] }
    ]
  },
  {
    category: 'Ambience',
    keywords: ['ambience', 'ambiance', 'atmos', 'atmosphere', 'background', 'roomtone', 'room tone', 'ambient'],
    subcategories: [
      { name: 'Interior', keywords: ['interior', 'room', 'indoor', 'house', 'office'] },
      { name: 'Exterior', keywords: ['exterior', 'outdoor', 'street', 'city', 'urban'] },
      { name: 'Nature', keywords: ['forest', 'wind', 'rain', 'nature', 'birds', 'water', 'storm'] }
    ]
  },
  {
    category: 'Coin',
    keywords: ['coin', 'money', 'cash', 'collect', 'collectible', 'gem', 'gold'],
    subcategories: [
      { name: 'Coin Drop', keywords: ['drop', 'fall', 'single'] },
      { name: 'Coin Collect', keywords: ['collect', 'pickup', 'pick up', 'get', 'reward'] },
      { name: 'Coin Count', keywords: ['count', 'tally', 'counter', 'stack', 'total'] }
    ]
  },
  {
    category: 'Slot',
  ...
  {
    category: 'Music',
    keywords: ['music', 'bgm', 'theme', 'melody', 'song', 'score', 'orchestral'],
    subcategories: [
  ...
  {
    category: 'Magic',
    keywords: ['magic', 'magical', 'sparkle', 'fairy', 'spell', 'enchant', 'mystic'],
    subcategories: [
      { name: 'Spell Cast', keywords: ['cast', 'spell'] },
      { name: 'Sparkle', keywords: ['sparkle', 'shimmer', 'twinkle', 'glitter'] },
      { name: 'Transformation', keywords: ['transform', 'morph', 'shift'] }
    ]
  },
  {
    category: 'Mechanical',
    keywords: ['mechanical', 'gear', 'machine', 'lever', 'motor', 'engine', 'servo', 'ratchet', 'winch'],
    subcategories: [
  ...
  {
    category: 'Creature',
    keywords: ['animal', 'monster', 'creature', 'beast', 'growl', 'roar', 'snarl', 'hiss'],
    subcategories: [
  ...
  {
    category: 'Foley',
    keywords: ['footstep', 'footsteps', 'foot step', 'walk', 'run', 'shoe', 'boot', 'cloth', 'fabric'],
    subcategories: [
  ...
  {
    category: 'Weapon',
    keywords: ['weapon', 'sword', 'gun', 'explosion', 'blast', 'rifle', 'pistol', 'blade', 'shot', 'bomb'],
    subcategories: [
      { name: 'Gunshot', keywords: ['gun', 'rifle', 'pistol', 'shot', 'shoot'] },
...
function scoreKeywords(text: string, tokens: Set<string>, keywords: string[]): number {
  let score = 0
...
export function classifySound(input: ClassifyInput): ClassifyResult {
  ...
  for (const rule of TAXONOMY) {
    ...
    for (const sub of rule.subcategories) {
      ...
      if (!bestSub || subScore > bestSub.score) bestSub = { name: sub.name, score: subScore }
    }
